	...
	public function registerAction()
	{
		...
		if($_SERVER['REQUEST_METHOD'] == 'POST') {
			...
			if ($_REQUEST['passwort']==$_REQUEST['passwort2']) {
				...
				if/*strtotime($_REQUEST["geburtsdatum"])!=false*/ ((Kurs::validateDate($_REQUEST["geburtsdatum"]) || (Kurs::validateDate($_REQUEST["geburtsdatum"], 'd.m.Y'))) && (strtotime($_REQUEST["geburtsdatum"])<=strtotime($currentdate))) {
