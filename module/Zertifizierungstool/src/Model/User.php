...
class User
{
	...
	public function register() {
		...
		$query = "insert into benutzer (benutzername, passwort, vorname, nachname, geburtsdatu, strasse, plz, ort, email, email_bestaetigt, ist_admin, ist_zertifizierer, ist_teilnehmer) values ('"
